 ...
 *
 *  $Id: SearchPRViewer.java 20085 2017-02-09 09:38:10Z markagreenwood $
 */
package gate.gui;
...
@CreoleResource(name = "Search Results", comment = "Viewer for IR search results", resourceDisplayed = "gate.creole.ir.SearchPR", mainViewer = true, guiType=GuiType.LARGE)
