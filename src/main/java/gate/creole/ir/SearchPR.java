...
@CreoleResource(name = "SearchPR", comment = "Provides IR functionality.", helpURL = "http://gate.ac.uk/userguide/sec:misc-creole:ir", icon="binoculars.gif")
public class SearchPR extends AbstractProcessingResource
  ...
  */
  ...
  @RunTime
  @CreoleParameter(comment="The indexed  corpus to be searched")
  ...
  @RunTime
  @CreoleParameter(comment="The search query")
  ...
  @RunTime
  @CreoleParameter(comment="The search implementation", defaultValue="gate.creole.ir.lucene.LuceneSearch")
  ...
  @RunTime
  @CreoleParameter(comment="The number of results returned", defaultValue="20")
  ...
  @RunTime
  @CreoleParameter(comment="The fields returned from result documents", defaultValue="*")
